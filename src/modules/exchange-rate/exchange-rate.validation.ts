...
import { ExchangeRateStatus } from '../../config/enums.js';
...
export const listExchangeRatesQuerySchema = z.object({
	...
	status: z.enum([ExchangeRateStatus.Ok, ExchangeRateStatus.Error, ExchangeRateStatus.Manual]).optional(),
...
export const updateExchangeRateBodySchema = z
	...
	.refine((body) => body.rates !== undefined || body.notes !== undefined || body.status !== undefined, {
		message: 'At least one field is required',
	});

export const listFxSyncLogsQuerySchema = z.object({
...
export type ListFxSyncLogsQuery = z.infer<typeof listFxSyncLogsQuerySchema>;
